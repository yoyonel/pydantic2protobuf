...
class ImpParametrizationCase(IParametrizationCase):
    ...
    expected_msg_definition: MessageDefinition
...
def test_gen_message_definition(pydantic_model: Type[BaseModel], expected_msg_definition: MessageDefinition):
    generated_msg_definition = gen_message_definition(pydantic_model)
    assert generated_msg_definition == expected_msg_definition
