...
from pydantic2protobuf.services.with_dataclasses.fastapi_to_proto import (
    EmptyGoogleType,
    MethodDefinition,
    ProtoFileContent,
    ServiceDefinition,
...
from pydantic2protobuf.services.with_dataclasses.pydantic_to_proto import FieldDefinition, MessageDefinition
